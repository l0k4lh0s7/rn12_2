...
const Pomodoros = ({navigation}) => {
  ...
  const [pomodoroConcentrationTime, setPomodoroConcentrationTime] =
    useState(300);
  const [pomodoroBreakTime, setPomodoroBreakTime] = useState(300);
  const [pomodoroSessions, setPomodoroSessions] = useState(0);
  const [autoRepeatSessionPomodoroSwitch, setAutoRepeatSessionPomodoroSwitch] =
    useState(false);
                  ...
                  <View
                    ...
                    <View
                      ...
                      {/* <Icon
                        ...
                        name="progress-clock"
                      /> */}
                      <MaterialCommunityIcons name="progress-clock" size={45} />
                      <View
                        style={{
                          // backgroundColor: 'orange',
                          marginLeft: 15,
                        ...
                        <View
                          ...
                          <View
                            ...
                            <Text
                              ...
                              {Math.floor(item.concentrationTime / 60)}:00
                            </Text>
                          </View>
                          <View
                            style={{
                            ...
                            <Text
                              ...
                              {Math.floor(item.breakTime / 60)}:00
                            </Text>
                          </View>
                          <View
                            style={{
